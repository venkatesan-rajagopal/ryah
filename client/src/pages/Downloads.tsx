  ...
  return (
    <div className="bg-[#F6E3C5] w-full min-h-screen relative overflow-x-hidden">
      <Button
        ...
        variant="default"
        className="absolute top-4 left-4 md:top-10 md:left-10 bg-[#9b705f] text-white h-10 rounded-[14px] px-4 md:px-6 uppercase font-bold text-sm md:text-base border border-black/8 z-20 hover:bg-[#8a6453]"
      >
